    <div id="page-wrapper">
        ...
        <div class="container-fluid">
         ...
         <div class="col-xs-12 col-sm-12">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                           <i class="fa fa-table"> <a href="<?=base_url()?>ordershopping/runViewProjectOrderShoppings/<?=$idProject?>"> Ordenes De Compra </a></i> 
                        </li>
          ...
          <?= form_open('ordershopping/updateorderShoppingInProyect/'.$idOrderShopping.'/'.$idProject); ?>    
            <?php 
                if ($ordershopping){
                   ?>    
