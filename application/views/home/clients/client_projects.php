            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                     Control De Proyectos del Cliente <b class="text-primary"><?= $nameClient ?></b>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
              ...
              <div class="row">
                    <div class="col-lg-10">
                      ...
                      <?php 
                                ...
                                echo "<h5 class='text-danger'>El Cliente ".$nameClient." No Contiene Ningun Proyecto  Favor De Agregar</h5>";
                            }
                        ?>  
                        </div>
                    </div>
             ...
             <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <?= form_open('projects/newProjectInClient/'.$idClient) ?>
