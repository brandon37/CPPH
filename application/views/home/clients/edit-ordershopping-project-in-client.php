    <div id="page-wrapper">
        ...
        <div class="container-fluid">
         ...
         <div class="col-xs-12 col-sm-12">
          ...
          <?= form_open('ordershopping/updateorderShoppingProyectInClient/'.$idOrderShopping.'/'.$idProject.'/'.$idClient); ?>    
            <?php 
                if ($ordershopping){
                   ?>    
                    ...
                    <?php 
                        ...
                        redirect('ordershopping/runViewOrderShoppingsProjectClientInSector/'.$idOrderShopping.'/'.$idProject);
                    }
                ?>    
                  </div> 
              </div>
