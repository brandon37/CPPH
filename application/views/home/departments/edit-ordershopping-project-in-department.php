    <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-table"> <a href="<?=base_url()?>departments">Departmamentos</a> </i>
                        </li>
                        ...
                        <li>
                            <i class="fa fa-table"> <a href="<?= base_url()?>ordershopping/runViewProjectOrderShoppingInDepartment/<?=$idProject ?>/<?= $idDepartment ?>">Ordenes De Compras</a> </i>
                        </li>
      ...
      <?= form_open('ordershopping/updateorderShoppingProyectinDepartment/'.$idOrderShopping.'/'.$idProject.'/'.$idDepartment); ?>    
        <?php 
            if ($ordershopping){
               ?>    
                ...
                <?php 
                    ...
                    redirect('ordershopping/runViewProjectOrderShoppingsInSector/'.$idProject.'/'.$idDepartment);
                }
            ?>    
              </div> 
          </div>
